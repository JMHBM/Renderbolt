...
**Latest: [1.0.11](https://github.com/JMHBM/Renderbolt/releases/tag/1.0.11)** · Linux AppImage · Windows installer and Debian `.deb` still [1.0.8](https://github.com/JMHBM/Renderbolt/releases/tag/1.0.8)
...
[![appimage](https://github.com/JMHBM/Renderbolt/actions/workflows/appimage.yml/badge.svg)](https://github.com/JMHBM/Renderbolt/actions/workflows/appimage.yml)
...
Download **[Renderbolt-1.0.11-x86_64.AppImage](https://github.com/JMHBM/Renderbolt/releases/download/1.0.11/Renderbolt-1.0.11-x86_64.AppImage)** from the [1.0.11 release](https://github.com/JMHBM/Renderbolt/releases/tag/1.0.11).
...
```bash
chmod +x Renderbolt-1.0.11-x86_64.AppImage
./Renderbolt-1.0.11-x86_64.AppImage
```

If FUSE is blocked:

```bash
./Renderbolt-1.0.11-x86_64.AppImage --appimage-extract-and-run
```

Headless:

```bash
./Renderbolt-1.0.11-x86_64.AppImage render --audio song.mp3 --cover art.jpg --out out.mp4
```
